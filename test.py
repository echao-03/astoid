...
def yellow_movement(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0: #Yellow Up
        yellow.y -= VEL   
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height < HEIGHT - 10: #Yellow Down
        yellow.y += VEL 
...
def red_movement(keys_pressed, red):
        ...
        if keys_pressed[pygame.K_UP] and red.y - VEL > 0: # Red Up
            red.y -= VEL   
        if keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height < HEIGHT - 10: # Red Down
            red.y += VEL  
